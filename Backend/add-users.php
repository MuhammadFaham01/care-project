    ...
    if (!empty($file_name)) {
        if (move_uploaded_file($file_tmp, $upload_dir . $file_name)) {
            ...
            if (mysqli_query($cons, $sql)) {
                echo "<script>alert('Signup successfully!'); window.location.href ='view-user.php';</script>";
            } else {
                ...
                <div class="bg-light rounded h-100 p-4">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" name="email" class="form-control" id="productPrice" aria-describedby="priceHelp" required>
                        </div>
                        <div class="mb-3">
                            <label for="productPrice" class="form-label">Password</label>
                            <input type="password" name="pass" class="form-control" id="productPrice" aria-describedby="priceHelp" required>
                        </div>
                        <div class="mb-3">
